...
def run_attack_tables_test():
  ...
  attack_squares = attack_tables.query_rook_attacks(Square(1), occ)
  ...
  occ = cb.get_all_pieces() | cb.get_all_pieces(ours=False)
  attack_squares2 = attack_tables.query_rook_attacks(Square(29), occ)
  ...
  occ = cb.get_all_pieces() | cb.get_all_pieces(ours=False)
  attack_squares3 = attack_tables.query_bishop_attacks(Square(2), occ)
  ...
  occ = cb.get_all_pieces() | cb.get_all_pieces(ours=False)
  attack_squares4 = attack_tables.query_bishop_attacks(Square(9), occ)
